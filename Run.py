...
#finds files with name "app*.py" > reads decription > creates corresponding menu item
for file in list(filter(lambda x: findall("app.*.py", x) != [], listdir())):
    f = open(file, 'r')
